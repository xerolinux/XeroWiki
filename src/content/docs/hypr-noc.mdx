...
import hyprNoc from '../../assets/images/HyprNoc.webp';
import hyprSvg from '../../assets/images/hypr.svg';

:::caution
We will not be held responsible for any issues you may encounter using this. It has been thoroughly tested. We do however, accept new ideas and suggestions, so please make sure to join us on the [Community Discord](https://discord.xerolinux.xyz).
:::
...
<Image src={hyprNoc} alt="Noctalia Shell on Hyprland" />
...
<Image src={hyprSvg} alt="Hyprland logo" />
...
:::danger
**Noctalia v5 is coming.** The project is moving away from **QuickShell** to a pure **C++** implementation, making it fully independent. When that happens, things on current installs will likely break. We will update the **T.U.I Installer** once v5 is stable, but fixing existing installs is on you. Follow the [**Noctalia v5 Wiki**](https://docs.noctalia.dev/v5/) when the time comes.
:::
