...
:::caution
This script formats the **entire disk**. No manual partitioning available. **Use at your own risk.** Source code: [**GitHub**](https://github.com/xerolinux/XeroHub/tree/main/public/script/xero-install)
:::
