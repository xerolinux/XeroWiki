...
### Features
  ...
  - Stop the server cleanly when done
  - Native KDE Plasma look with blur/transparency support
  - Built with Qt6/QML for a fast, native feel
