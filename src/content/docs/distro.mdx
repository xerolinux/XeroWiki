...
If you see a *"Limited Connectivity"* notification show up, it has nothing to do with your connection, but a known `plasma-nm` bug. The only way to get rid of it temporarily, is by ignoring it or just disabling any notifications from it, it's nothing major, just a cosmetic thing. Nothing we can do about that, it's up to Plasma Devs, the ball is in their court now.
